...
describe('Test Stock Availability State Machine', () => {
    ...
    it('Should be Availability :: OUT', () => {
        ...
        expect(stockInfo.stockLevelAvailability).toBe(STOCK_AVAILABILITY.OUT);
    })
    ...
    it('Should be Availability :: LOW', () => {
        ...
        expect(stockInfo.stockLevelAvailability).toBe(STOCK_AVAILABILITY.LOW);
    })
    ...
    it('Should be Availability :: MEDIUM', () => {
        ...
        expect(stockInfo.stockLevelAvailability).toBe(STOCK_AVAILABILITY.MEDIUM);
    })
    ...
    it('Should be Availability :: HIGH', () => {
        ...
        expect(stockInfo.stockLevelAvailability).toBe(STOCK_AVAILABILITY.HIGH);
    })
})
